class Note {
  ...
  // Tạo một bản sao của Note với các thuộc tính có thể cập nhật
  Note copyWith({
    int? id,
    String? title,
    String? content,
  ...
  // Chuyển đổi Note thành Map (hữu ích cho database)
  Map<String, dynamic> toMap() {
    return {
      ...
      'tags': tags?.join(','), // Lưu tags dưới dạng chuỗi phân cách bằng dấu phẩy
      'color': color,
    };
  }
